...
CREATE VIEW INFORMATION_SCHEMA.VIEWS
              AS SELECT
                'DEFAULT' AS TABLE_CATALOG, TABLE_SCHEMA, TABLE_NAME, VIEW_DEFINITION,
                  '' AS CHECK_OPTION, 'false' AS IS_UPDATABLE
              FROM DEFINITION_SCHEMA.VIEWS;
-- 21.2.9 COLUMNS
CREATE VIEW INFORMATION_SCHEMA.COLUMNS
              AS SELECT DISTINCT
                'DEFAULT' AS TABLE_CATALOG, TABLE_SCHEMA, TABLE_NAME,
...
CREATE VIEW INFORMATION_SCHEMA.TABLE_PRIVILEGES
              AS SELECT
                GRANTOR, GRANTEE, TABLE_CATALOG, OBJECT_SCHEMA, OBJECT_NAME,
